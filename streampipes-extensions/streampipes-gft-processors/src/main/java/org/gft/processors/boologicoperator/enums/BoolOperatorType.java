...
package org.gft.processors.boologicoperator.enums;
...
public enum BoolOperatorType {
    ...
    BoolOperatorType(String operator, String description) {
    ...
    public static BoolOperatorType getBooleanOperatorType(String operator) {
