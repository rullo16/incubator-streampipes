...
public class BoolTimerParameters extends EventProcessorBindingParams {
    private String fieldName;
    private boolean measureTrue;
    private double outputDivisor;

    public BoolTimerParameters(DataProcessorInvocation graph, String fieldName, boolean measureTrue, double outputDivisor) {
        super(graph);
