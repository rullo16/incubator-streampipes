...
package org.gft.processors.boologicoperator.operations;

/**
 * Represents a boologicoperator boolean operation.
 */
public interface IBoolOperation<T extends Boolean> {
    /**
     *
     * Performs the boologicoperator boolean operation b/w operands and returns the result
